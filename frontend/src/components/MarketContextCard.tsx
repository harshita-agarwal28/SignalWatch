...
export function MarketContextCard({ snapshot }: MarketContextCardProps) {
  return (
    <div className="glass-panel hover-lift rounded-2xl p-5">
      ...
      <div className="mt-5">
        <div className="relative h-2 rounded-full bg-gradient-to-r from-signal/30 via-amber/40 to-coral/50">
          <div
          ...
          >
            <span
              ...
              style={{
                boxShadow:
                  snapshot.pulse === 'heated'
                    ? '0 0 0 3px rgba(255,107,107,0.35)'
                    : snapshot.pulse === 'balanced'
                      ? '0 0 0 3px rgba(245,185,66,0.35)'
                      : '0 0 0 3px rgba(117,172,238,0.35)',
              }}
            />
          </div>
        </div>
